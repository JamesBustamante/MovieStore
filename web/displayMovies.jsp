...
<% 
    ...
    if (searchParam.getGenre().equals("Any") || !genreHasInput) {
        ...
        matches = movies.getGenreMatches(searchParam.getGenre());
    ...
    ArrayList<Movie> complement = new ArrayList<Movie>();
    complement.addAll(matches);
    complement.removeAll(moviesSelected);

%>
<c:set var = "xmltext"> 
    <movies> 
        <% for (Movie movie : complement) {
        %>
        <movie>
